...
const Wallet = () => {
  ...
  return (
    <section className='bg-gray-100 text-gray-900 min-h-screen'>
      {
        user && user.emailVerfi ?
          <div className='flex justify-center text-gray-900 min-h-screen'>
            <p className='text-4xl text-center p-40'>
              Please Verify Your Email.
              <br />
              Verification Link  Been Sent to Your Email Address
            </p>
          </div>
          :
